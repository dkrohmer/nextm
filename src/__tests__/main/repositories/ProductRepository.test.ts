...
describe('ProductRepository', () => {
  ...
  it('should get a product by id', async () => {
    ...
    const foundProduct = await productRepository.getProductById(
      savedProduct.id,
      false,
    );
  ...
  it('should delete a product', async () => {
    ...
    const deletedProduct = await productRepository.getProductById(
      savedProduct.id,
      false,
    );
  ...
  it('should not throw an error when deleting a non-existent product', async () => {
    await expect(
      productRepository.deleteProduct('non-existent-id'),
