...
const Footer: React.FC = () => (
  <Segment inverted={true} vertical style={{  padding: '1em 0em', fontSize: 'small' }}>
    <Container textAlign='center'>
      <Grid centered stackable>
        <Grid.Column width={3} textAlign='center'>
          <a href="https://github.com/dkrohmer/" target="_blank" rel="noopener noreferrer" style={{...flexStyle}}>
            <Icon name='github' size='large' />
            <List.Item as='h5' content='Contribute' style={{ margin: 0 }} />
          </a>
        </Grid.Column>
        <Grid.Column width={3} textAlign='center'>
          <a href="https://discord.com" target="_blank" rel="noopener noreferrer" style={{...flexStyle}}>
            <Icon name='discord' size='large' />
            <List.Item as='h5' content='Discuss' style={{ margin: 0 }} />
          </a>
        </Grid.Column>
        <Grid.Column width={3} textAlign='center'>
          <a href="https://patreon.com" target="_blank" rel="noopener noreferrer" style={{...flexStyle}}>
