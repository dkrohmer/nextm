...
const SideBar: React.FC = () => {
  ...
  const [selectedPath, setSelectedPath] = useState<string | null>('default');
  ...
  const handleDatabaseTypeChange = async (_: React.FormEvent<HTMLInputElement>, { value }: any) => {
  ...
  const handleGridChange = (_: React.FormEvent<HTMLInputElement>, { value }: any) => {
    ...
    <>
      ...
      >
        ...
        <Accordion inverted={true}>
          <Segment inverted={true} style={{ border: '0.5px solid gray', borderRadius: '4px' }}>
            <Accordion.Title
              ...
              <Segment basic>
                <Form inverted={true}>
                  <div>
                    ...
                    <Popup 
                      trigger={<Icon name='info circle' style={{display: 'inline-block', paddingLeft: '10px'}} inverted={true} />} 
                  ...
                  <Button primary disabled={isSetDatabaseDisabled} onClick={handleFormSubmit}>
                    {buttonLabel}
                  </Button>
                </Form>
              </Segment>
          ...
          <Segment inverted={true} style={{ border: '0.5px solid gray', borderRadius: '4px' }}>
            ...
            <Accordion.Content active={activeIndex === 1}>
              <Segment basic>
                ...
                */}
                <Form inverted={true} style={{paddingTop: '50px'}}>
                  <div>
                    <h3 style={{display: 'inline-block'}}>
                      <label>
                        Set explicit object selection
                      </label>
                    </h3>
                    <Popup 
                      trigger={<Icon name='info circle' style={{display: 'inline-block', paddingLeft: '10px'}} inverted={true} />} 
