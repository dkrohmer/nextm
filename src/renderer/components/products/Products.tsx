...
const Products: React.FC = () => {
  ...
  return (
    <Container style={{ marginTop: '10em' }}>
      ...
      <Segment basic>
        {/* Loader */}
        <Dimmer active={productsIsLoading} inverted>
        ...
        <Table size="small">
          ...
          <Table.Body>
            ...
            {!productsError && !productsIsLoading && products.length <= 0 && (
              <Table.Row>
                <Table.Cell colSpan="8" textAlign="center">
                  <h3 className="empty-message-header">It's quiet here 💤</h3>
                  ...
                  <Table.Cell style={{ maxWidth: '300px' }}>
                    <div className="ellipsis">
                      {product.responsibles && product.responsibles.length > 0
                        ? formatResponsibles(product.responsibles)
                        : 'n/a'}
                    </div>
                  </Table.Cell>
                  <Table.Cell>
      ...
      {/* Pagination */}
      <div
        style={{ display: 'flex', paddingTop: '20px', paddingBottom: '50px' }}
      >
        <div style={{ flex: 1, justifyContent: 'left', display: 'flex' }}>
          <Pagination
